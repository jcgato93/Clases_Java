 ...
 * @author juan camilo
 */
public class JToolBar_BarraHerramientas extends javax.swing.JFrame {

    /**
     * Creates new form JToolBar_BarraHerramientas
     */
    public JToolBar_BarraHerramientas() {
        initComponents();
    ...
    private void initComponents() {
        ...
        ToolBar.setBorder(new javax.swing.border.MatteBorder(null));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JToolBar_BarraHerramientas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JToolBar_BarraHerramientas().setVisible(true);
            }
        });
    }
